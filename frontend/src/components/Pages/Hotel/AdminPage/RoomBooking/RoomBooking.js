...
const RoomBooking = () => {
  ...
  const handleRoomTypeChange = (e) => {
    ...
    const selectedRoom = get?.rom?.find((item) => item.Room_Type === selectedRoomType);
    if (selectedRoom) {
      setPrice(selectedRoom.Price);
    }
    setRoom_Type(selectedRoomType); 
  };
        ...
        <Container style={{ width: "90%", marginTop: "20px" }}>
          <Table striped bordered hover className="main-table">
            <thead>
              <tr>
                <th>
                  <h5><AiFillDashboard /> &nbsp;Dasboard / Add Booking Room</h5>
                </th>
              </tr>
            </thead>
          </Table>
              ...
              <form className="row g-4 p-3 registration-form">
                ...
                <div className="col-md-4 position-relative">
                  ...
                  <Form.Select
                   ...
                   >
                    ...
                    {get?.rom?.map((item, index) => (
                      <option key={index}>{item.Room_Type}</option>
                    ))}
                  </Form.Select>
                </div>
                ...
                <div className="col-md-4 position-relative">
                  ...
                  <input
                    ...
                    onChange={(e) => setCheckin_Date_Time(e.target.value)}
                    required
                  />
                </div>
                ...
                <div className="col-md-4 position-relative">
                  ...
                  <input
                    ...
                    onChange={(e) => setCheckout_Date_Time(e.target.value)}
                    required
                  />
                </div>
                ...
                <div className="col-md-4 position-relative">
                  ...
                  <input
                    ...
                    onChange={(e) => setNumber_Of_Children(e.target.value)}
                    required
                  />
                </div>
